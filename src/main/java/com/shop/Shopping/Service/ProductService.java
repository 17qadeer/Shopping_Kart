...
public class ProductService {
    ...
    private double calculateSimilarity(ProductVariation product1, ProductVariation product2) {
        ...
        double similarity = 0.65 * categorySimilarity + 0.35 * priceRangeSimilarity;
...
//    }
    ...
    public List<ProductVariation> searchByName(String name) {
        // Perform case-insensitive search for products starting with the given name
        return productvariationRepository.findByNameContainingIgnoreCase(name);
    }
    public List<ProductVariation> searchByType(String type) {
        // Perform case-insensitive search for products by type
        return productvariationRepository.findByTypeContainingIgnoreCase(type);
    }
